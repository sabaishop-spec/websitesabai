                ...
                >
                  ...
                  <div className="mt-auto pt-8 border-t border-brand-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 relative z-10 shrink-0">
                    ...
                    <Link
                      ...
                      className="group flex flex-row items-center gap-2 text-brand-700 hover:text-brand-900 transition-colors font-medium text-base bg-brand-50 hover:bg-brand-100 px-6 py-3 rounded-full border border-brand-100 shrink-0 max-w-full overflow-hidden"
                    >
